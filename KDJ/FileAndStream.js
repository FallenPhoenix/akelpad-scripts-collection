...
if (! bDualPan)
  oWndMin.W = Math.round((oWndMin.W - 2 * oSys.Call("user32::GetSystemMetrics", 32 /*SM_CXSIZEFRAME*/)) / 2) +
              2 * oSys.Call("user32::GetSystemMetrics", 32 /*SM_CXSIZEFRAME*/);
...
function DialogCallback(hWnd, uMsg, wParam, lParam)
{
  if (uMsg == 1) //WM_CREATE
  {
    ...
    AkelPad.MemCopy(lpBuffer, 52, DT_DWORD);
    oSys.Call("user32::GetComboBoxInfo", aWnd[IDFILTERCB0][HWND], lpBuffer);
    hWndFilterEdit0 = AkelPad.MemRead(lpBuffer + 44 /*hwndItem*/, DT_DWORD);
    oSys.Call("user32::GetComboBoxInfo", aWnd[IDFILTERCB1][HWND], lpBuffer);
    hWndFilterEdit1 = AkelPad.MemRead(lpBuffer + 44 /*hwndItem*/, DT_DWORD);
  ...
  else if (uMsg == 0x0138) //WM_CTLCOLORSTATIC
  {
    ...
    {
      oSys.Call("gdi32::SetTextColor", wParam, oSys.Call("user32::GetSysColor", 9 /*COLOR_CAPTIONTEXT*/));
      oSys.Call("gdi32::SetBkColor", wParam, oSys.Call("user32::GetSysColor", 2 /*COLOR_ACTIVECAPTION*/));
      return oSys.Call("user32::GetSysColorBrush", 2 /*COLOR_ACTIVECAPTION*/);
    }
  }
  ...
  else if ((uMsg == 0x004E /*WM_NOTIFY*/) && (wParam >= IDFILELV0) && (wParam <= IDSTREAMLV1))
  {
    switch (AkelPad.MemRead(lParam + 8, DT_DWORD))
    {
      case -101 : //LVN_ITEMCHANGED
        if (AkelPad.MemRead(lParam + 20 /*uNewState*/, DT_DWORD) == 0x3 /*LVIS_SELECTED|LVIS_FOCUSED*/)
        {
          if (wParam <= IDFILELV1)
      ...
      case -6 : //NM_RDBLCLK
        if (AkelPad.MemRead(lParam + 12, DT_DWORD) == -1) //NMITEMACTIVATE.iItem
          ...
          ContextMenu(AkelPad.MemRead(lParam, DT_DWORD) /*hwndFrom*/, lParam + 32 /*ptAction*/);
        break;

      case -155 : //LVN_KEYDOWN
        if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 9 /*VK_TAB*/) && (! Alt()))
        {
          if (Ctrl() || Shift())
        ...
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x70 /*VK_F1*/)
        {
          if ((! Ctrl()) && (! Shift()) && (! Alt()))
            MainMenu();
          else if ((! Ctrl()) && (! Shift()) && Alt())
        ...
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x72 /*VK_F3*/)
        {
          if ((! Ctrl()) && (! Shift()) && (! Alt()))
            OpenIn(0, 1);
          else if (Ctrl() && (! Shift()) && (! Alt()))
        ...
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x73 /*VK_F4*/)
        {
          if ((! Ctrl()) && (! Shift()) && (! Alt()))
            OpenIn(1, 1);
          else if (Ctrl() && (! Shift()) && (! Alt()))
        ...
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x74 /*VK_F5*/) &&
                 (! Ctrl()) && (! Alt()))
          Copy(0, Shift());

        //VK_F6 in ListCallback() -> Copy(1, 0)

        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x76 /*VK_F7*/) &&
                 (! Ctrl()) && (! Alt()))
          Create(! Shift());
        else if (((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x77 /*VK_F8*/) ||
                  (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x2E /*VK_DELETE*/)) &&
                 (! Ctrl()) && (! Alt()))
          Delete(! Shift());
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x78 /*VK_F9*/) &&
                 (! Ctrl()) && (! Shift()) && (! Alt()))
          RefreshPanel(2);
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x7B /*VK_F12*/)
        {
          if ((! Ctrl()) && (! Shift()) && (! Alt()))
            Compare(1);
          else if (Ctrl() && (! Shift()) && (! Alt()))
        ...
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x25 /*VK_LEFT*/)
        {
          if ((! Ctrl()) && (! Shift()) && (! Alt()))
            Open(nCurPan, -1);
          else if (Ctrl() && (! Shift()) && (! Alt()))
        ...
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x27 /*VK_RIGHT*/)
        {
          if ((! Ctrl()) && (! Shift()) && (! Alt()))
            Open(nCurPan, 1);
          else if (Ctrl() && (! Shift()) && (! Alt()))
        ...
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x26 /*VK_UP*/) &&
                 (! Ctrl()) && Shift() && Alt())
          MoveDialog("U");
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x28 /*VK_DOWN*/) &&
                 (! Ctrl()) && Shift() && Alt())
          MoveDialog("D");
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x23 /*VK_END*/) &&
                 (! Ctrl()) && Shift() && Alt())
          MoveDialog("E");
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x24 /*VK_HOME*/) &&
                 (! Ctrl()) && Shift() && Alt())
          MoveDialog("H");
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x21 /*VK_PRIOR*/) &&
                 (! Ctrl()) && Shift() && Alt())
          MoveDialog("T");
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x22 /*VK_NEXT*/) &&
                 (! Ctrl()) && Shift() && Alt())
          MoveDialog("B");
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x2D /*VK_INSERT*/)
          CopyNameToCB(Number(Ctrl()) + Number(Shift()) * 2 + Number(Alt()) * 4);
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x31 /*1 key*/) &&
                 (! Ctrl()) && (! Shift()) && Alt())
        {
          if (bDualPan || (nCurPan == 0))
            oSys.Call("user32::SetFocus", aWnd[IDFILTERCB0][HWND]);
        }
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x32 /*2 key*/) &&
                 (! Ctrl()) && (! Shift()) && Alt())
        {
          if (bDualPan || (nCurPan == 1))
            oSys.Call("user32::SetFocus", aWnd[IDFILTERCB1][HWND]);
        }
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x43 /*C key*/)
        {
          if ((! Ctrl()) && Shift() && Alt())
            MoveDialog("C");
          else if (Ctrl() && (! Shift()) && (! Alt()))
        ...
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x46 /*F key*/) &&
                 (! Ctrl()) && (! Shift()) && Alt())
          FavoriteFolders(nCurPan);
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x48 /*H key*/) &&
                 (! Ctrl()) && (! Shift()) && Alt())
          History(nCurPan);
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x4D /*M key*/) &&
                 (! Ctrl()) && Shift() && Alt())
          MoveDialog("M");
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x51 /*Q key*/) &&
                 Ctrl() && (! Shift()) && (! Alt()))
          ShowQuickView();
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x53 /*S key*/) &&
                 (! Ctrl()) && (! Shift()) && Alt())
          SpecialFolders(nCurPan);
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0x55 /*U key*/) &&
                 Ctrl() && (! Shift()) && (! Alt()))
          SwapPanels();
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 0xDC /*VK_OEM_4 == backslash*/) &&
                 Ctrl() && (! Shift()) && (! Alt()))
          Open(nCurPan, -2);
        else if (AkelPad.MemRead(lParam + 12, DT_WORD) == 0x5D /*VK_APPS*/)
          ContextMenu(AkelPad.MemRead(lParam, DT_DWORD) /*hwndFrom*/);
        else if ((AkelPad.MemRead(lParam + 12, DT_WORD) == 27 /*VK_ESCAPE*/) &&
                 (! Ctrl()) && (! Shift()) && (! Alt()))
      ...
      case -12 : //NM_CUSTOMDRAW
        ...
        {
          AkelPad.MemCopy(lParam + 40 /*uItemState*/, 0x20 /*CDIS_DEFAULT*/, DT_DWORD);

          if (AkelPad.MemRead(lParam + 12 /*dwDrawStage*/, DT_DWORD) == 0x1 /*CDDS_PREPAINT*/)
            return 0x20; //CDRF_NOTIFYITEMDRAW
          else if (AkelPad.MemRead(lParam + 12, DT_DWORD) == 0x10001 /*CDDS_ITEMPREPAINT*/)
            return 0x20; //CDRF_NOTIFYSUBITEMDRAW
          else if ((AkelPad.MemRead(lParam + 12, DT_DWORD) == 0x30001 /*CDDS_ITEMPREPAINT|CDDS_SUBITEM*/) &&
                   (AkelPad.MemRead(lParam + 36 /*dwItemSpec*/, DT_DWORD) == GetCurSelLV(aWnd[wParam][HWND])))
          {
            if (wParam == IDFILELV0 + Number(! nCurPan) + aCurWnd[Number(! nCurPan)] * 2)
            {
              AkelPad.MemCopy(lParam + 48 /*clrText*/, oSys.Call("user32::GetSysColor", 3 /*COLOR_INACTIVECAPTION*/), DT_DWORD);
              AkelPad.MemCopy(lParam + 52 /*clrTextBk*/, oSys.Call("user32::GetSysColor", 19 /*COLOR_INACTIVECAPTIONTEXT*/), DT_DWORD);
            }
            else
            {
              AkelPad.MemCopy(lParam + 48 /*clrText*/, oSys.Call("user32::GetSysColor", 14 /*COLOR_HIGHLIGHTTEXT*/), DT_DWORD);
              AkelPad.MemCopy(lParam + 52 /*clrTextBk*/, oSys.Call("user32::GetSysColor", 13 /*COLOR_HIGHLIGHT*/), DT_DWORD);
            }
      ...
      case -108 : //LVN_COLUMNCLICK
        if (AkelPad.MemRead(lParam + 16, DT_DWORD) < 4)
        {
          SetSortInHeader(AkelPad.MemRead(lParam +  4, DT_DWORD),
                          AkelPad.MemRead(lParam + 16, DT_DWORD));
          SortList(AkelPad.MemRead(lParam + 4, DT_DWORD));
        }
    }
  }
...
function InsertColumnsLV()
{
  ...
  for (i = IDFILELV0; i <= IDFILELV1; ++i)
  {
    ...
    for (n = 0; n < aFmt.length; ++n)
    {
      ...
      AkelPad.MemCopy(lpLVCOLUMN + 12, aText[n], DT_DWORD);
...
function SetSortInHeader(nID, nCol)
{
  ...
  if (nID == -1)
  {
    for (nID = IDFILELV0; nID <= IDSTREAMLV1; ++nID)
    {
      ...
      for (nCol = 0; nCol < AkelPad.SendMessage(hHeader, 0x1200 /*HDM_GETITEMCOUNT*/, 0, 0) - ((nID <= IDFILELV1) ? 1 :0); ++nCol)
      {
        ...
        nFmt = AkelPad.MemRead(lpHDITEM + 20, DT_DWORD); //fmt
        ...
        AkelPad.MemCopy(lpHDITEM + 20, nFmt, DT_DWORD);
  ...
  else
  {
    ...
    nFmt = AkelPad.MemRead(lpHDITEM + 20, DT_DWORD); //fmt
    AkelPad.MemCopy(lpHDITEM + 20, nFmt | (aSort[nID - IDFILELV0][1] ? HDF_SORTDOWN : HDF_SORTUP), DT_DWORD);
    AkelPad.SendMessage(hHeader, 0x120C /*HDM_SETITEMW*/, nCol, lpHDITEM);
  }
...
function SortList(nID)
{
  ...
  oSys.Call("user32::SendMessageW", hWndSort, 0x1051 /*LVM_SORTITEMSEX*/, aSort[nID - IDFILELV0][1], lpCallback);
...
function FillFilterList(sFilter)
{
  ...
  {
    oSys.Call("user32::SendMessageW", aWnd[IDFILTERCB0][HWND], 0x0143 /*CB_ADDSTRING*/, 0, aFilter[i]);
    oSys.Call("user32::SendMessageW", aWnd[IDFILTERCB1][HWND], 0x0143 /*CB_ADDSTRING*/, 0, aFilter[i]);
  }
...
function FillDriveList(nPan)
{
  ...
  for (i = 0; i <= sLogDrives.length; ++i)
  {
    if (sLogDrives.charAt(sLogDrives.length - i - 1) == "1")
    {
      ...
      nPos   = oSys.Call("user32::SendMessageW", aWnd[IDDRIVECB0 + nPan][HWND], 0x0143 /*CB_ADDSTRING*/, 0, sDrive);
...
{
  AkelPad.SendMessage(aWnd[IDDRIVECB0 + nPan][HWND], 0x0148 /*CB_GETLBTEXT*/,
                      AkelPad.SendMessage(aWnd[IDDRIVECB0 + nPan][HWND], 0x0147 /*CB_GETCURSEL*/, 0, 0), lpBuffer);
