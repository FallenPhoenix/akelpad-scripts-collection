...
//
// -"В белый список" Call("Scripts::Main", 1, "SpellCheckAddToWhiteList.js")	-	будет добавлено в белый список по текущему расширению в ASCII
// -"В белый список" Call("Scripts::Main", 1, "SpellCheckAddToWhiteList.js", `-ext="txt" -format=-1`)	-	будет добавлено в белый список для txt в Unicode
